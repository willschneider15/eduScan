...
const VerifyArgs_1 = require("../types/VerifyArgs");
exports.VerifyStruct = new beet.FixableBeetArgsStruct([
    ['instructionDiscriminator', beet.u8],
    ['verifyArgs', VerifyArgs_1.verifyArgsBeet],
...
function createVerifyInstruction(accounts, args, programId = new web3.PublicKey('metaqbxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s')) {
    ...
    const keys = [
        ...
        {
            pubkey: (_a = accounts.authorizationRules) !== null && _a !== void 0 ? _a : programId,
            isWritable: false,
            isSigner: false,
        },
        {
