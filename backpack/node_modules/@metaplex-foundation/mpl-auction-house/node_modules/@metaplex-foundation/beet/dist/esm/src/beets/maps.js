import { BEET_PACKAGE, isFixedSizeBeet, } from '../types';
        ...
        write: function (buf, offset, map) {
            ...
            for (const [k, v] of map.entries()) {
                ...
                if (fixedKey == null || fixedVal == null) {
                    ...
                    assert(els != null, `Should be able to find beet els for ${k.toString()}, but could not`);
            ...
            assert.equal(size, len, `Expected map to have size ${len}, but has ${size}.`);
        },
 ...
 * @category beet/composite
 */
export function map(keyElement, valElement) {
