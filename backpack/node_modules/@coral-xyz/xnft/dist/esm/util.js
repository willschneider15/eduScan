...
export function buildAnonymousProvider(connection) {
    return new AnchorProvider(connection, 
    /* eslint @typescript-eslint/ban-ts-comment: 0 */
    // @ts-ignore
    { publicKey: PublicKey.default }, {});
}
export function buildAnonymousProgram(connection) {
...
export function enumsEqual(variant, other) {
    return Object.keys(variant)[0] === other;
}
export function gatewayUri(uri) {
