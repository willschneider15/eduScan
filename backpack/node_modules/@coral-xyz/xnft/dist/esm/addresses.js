 ...
 */
export function deriveAccessAddress(wallet, xnft) {
 ...
 * @returns {[PublicKey, number]}
 */
export function deriveInstallAddress(authority, xnft) {
 ...
 * @returns {[PublicKey, number]}
 */
export function deriveMasterMintAddress(name, publisher) {
 ...
 * @returns {[PublicKey, number]}
 */
export function deriveReviewAddress(xnft, author) {
 ...
 * @returns {[PublicKey, number]}
 */
export function deriveXnftAddress(masterMint) {
